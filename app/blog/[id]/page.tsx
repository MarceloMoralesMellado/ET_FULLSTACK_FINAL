...
export default function PaginaArticuloBlog({
  ...
  useEffect(() => {
    ...
    const articuloEncontrado = articulos.find((a) => a.id === id && a.activo)
    ...
    setComentarios(obtenerComentariosPorArticulo(id))
  }, [id, router])
  ...
  const handleSubmitComentario = (e: React.FormEvent) => {
    ...
    agregarComentario(id, nuevoComentario.nombre.trim(), nuevoComentario.comentario.trim())
