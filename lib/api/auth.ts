...
export async function iniciarSesion(
  ...
  try {
    ...
    return {
      usuario: convertirUsuario(authData.record as unknown as UsuarioRecord),
      error: null,
    }
  } catch (error: any) {
...
export function obtenerUsuarioActual(): Usuario | null {
  ...
  return convertirUsuario(pb.authStore.model as unknown as UsuarioRecord)
}
...
export function esAdmin(): boolean {
  ...
  const usuario = pb.authStore.model as unknown as UsuarioRecord
